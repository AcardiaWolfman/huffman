...
struct MinHeapNode
{
    ...
    unsigned freq;
    /** Izquierda o derecha del nodo Ni�o */
...
/** Crea un min mont�n de la misma capacidad y tama�o e inserta todos los caracteres de data[] en minheap. Inicialmente minheap es igual a la capacidad */
...
struct MinHeapNode* buildHuffmanTree(char data[], int freq[], int size)
{
    ...
    /** paso 1: crear un minheap (coleccion de nodos) de igual capacidad y tama�o que inicialmente ahy Nodos igual al tama�o */
...
/** Imprime c�digos Huffman de la ra�z del �rbol de Huffman. Utiliza arr [] parac�digos de tienda */
...
int main()
{
    ...
    int i1=0;
    int *fpp=0;
    int tamal=cantar(fpp,app);
    char arr[tamal];
    int freq[tamal];
    for(i1=0;i1<tamal;i1++){
      arr[i1]=*(app+i1);
      freq[i1]=*(fpp+i1);
    }

arr[i1]=*(app+i1);    //char arr[] = {'j', 'u', 'a', 'n', 'i', 't','o','p','r','s','q','-'};
